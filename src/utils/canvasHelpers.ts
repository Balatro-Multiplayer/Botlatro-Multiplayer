...
async function drawAvatar(
  ...
  //hide corners
  const tl = await loadImage('../dist/assets/hideTL.png')
  const tr = await loadImage('../dist/assets/hideTR.png')
  const bl = await loadImage('../dist/assets/hideBL.png')
  const br = await loadImage('../dist/assets/hideBR.png')
...
async function addBackground(
  ...
  const bg = await loadImage(
    path.join(__dirname, '../dist/assets/backgrounds', filename),
  )
...
async function addRedBox(
  ...
  const tl = await loadImage('../dist/assets/RedTL.png')
  const tr = await loadImage('../dist/assets/RedTR.png')
  const bl = await loadImage('../dist/assets/RedBL.png')
  const br = await loadImage('../dist/assets/RedBR.png')
...
async function addGrayBox(
  ...
  const tl = await loadImage('../dist/assets/GrayTL.png')
  const tr = await loadImage('../dist/assets/GrayTR.png')
  const bl = await loadImage('../dist/assets/GrayBL.png')
  const br = await loadImage('../dist/assets/GrayBR.png')
...
async function addBlueBox(
  ...
  const tl = await loadImage('../dist/assets/BlueTL.png')
  const tr = await loadImage('../dist/assets/BlueTR.png')
  const bl = await loadImage('../dist/assets/BlueBL.png')
  const br = await loadImage('../dist/assets/BlueBR.png')
...
async function addBlackBox(
  ...
  const tl = await loadImage('../dist/assets/BlackTL.png')
  const tr = await loadImage('../dist/assets/BlackTR.png')
  const bl = await loadImage('../dist/assets/BlackBL.png')
  const br = await loadImage('../dist/assets/BlackBR.png')
...
async function addBackBox(
  ...
  const tl = await loadImage('../dist/assets/bgTL.png')
  const tr = await loadImage('../dist/assets/bgTR.png')
  const bl = await loadImage('../dist/assets/bgBL.png')
  const br = await loadImage('../dist/assets/bgBR.png')
...
async function rankupBar(
  ...
  async function corner(x: number, y: number, xlen: number, ylen: number) {
    const tl = await loadImage('../dist/assets/antiTL.png')
    const tr = await loadImage('../dist/assets/antiTR.png')
    const bl = await loadImage('../dist/assets/antiBL.png')
    const br = await loadImage('../dist/assets/antiBR.png')
